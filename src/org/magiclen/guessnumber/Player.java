...
public abstract class Player {
     ...
     */
    public final void setGuessTimes(int inputNum) {
     ...
     */
    public final void setLastGuess(String inputString) {
     ...
     * @param inputString 傳入猜的數
     */
    public final void setLastHint(String inputString) {
     ...
     */
    public boolean checkAnswer(String inputString) {
     ...
     * @return 若為正確的格式傳回true；否則傳回false
     */
    public boolean checkHint(String inputString) {
     ...
     */
    public void talk(int sentence) {
	String congratulationMessage; //儲存遊戲結束時電腦玩家要向使用者顯示的句子
	if (sentence < 5) {
     ...
     * @see Talk
     */
    public abstract void talk(Talk sentence);
     ...
     */
    public abstract void replyHint(Player respondent);
     ...
     */
    public abstract void respondQuestion(Player asker);
